...
class _MediaSelectorState extends State<MediaSelector> {
  String _mediaPath = ''; // <-- untuk menyimpan path ke media yang dipilih pengguna
  ...
  // Menghilangkan tampilan media yang dipilh.
  ...
  Widget _mediaPlaceholder() {
    ...
    if (widget.mediaType == MediaType.photo) {
      ...
      caption = 'No Video';
      placeholderWidget = VideoPreview(path: _mediaPath); // <-- Nanti kita ganti dengan komponen yang kita buat
    }
          ...
          child: Column(
            children: [
              Container(
                ...
                child:
                    _mediaPlaceholder(), // <-- Fungsi yang kita buat tadi dipanggil disini
              ),
              Container(
