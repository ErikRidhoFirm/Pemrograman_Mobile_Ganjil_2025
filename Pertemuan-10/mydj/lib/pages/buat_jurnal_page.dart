            ...
            children: [
              ...
              TextField(
                ...
                onChanged: (value) => {
                  setState(() {
                    kelas =
                        value; // <-- Dengan begini, apapun teks yang diinputkan pengguna akan selalu di-update ke property 'kelas' pada class ini (_BuatJurnalPageState), yang kita definisikan diatas.
                  }),
                },
              ),
              ...
              SizedBox(
                height: 10,
              ), // beri 10 unit jarak dari komponen di atasnya
              Text('Nama Mapel'),
              SizedBox(height: 10),
              TextField(
                decoration: InputDecoration(
